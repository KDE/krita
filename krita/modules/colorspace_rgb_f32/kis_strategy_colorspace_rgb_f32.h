...
public:
	KisStrategyColorSpaceRGBF32();
	virtual ~KisStrategyColorSpaceRGBF32();
...
private:
	friend class KisStrategyColorSpaceRGBF32Tester;
...
typedef KSharedPtr<KisStrategyColorSpaceRGBF32> KisStrategyColorSpaceRGBF32SP;
