...
class KisExportQmicProcessingVisitor : public KisSimpleProcessingVisitor
{
public:
    KisExportQmicProcessingVisitor(const KisNodeListSP nodes, QSharedPointer< QVector<gmic_image<float> > > images, QRect rc = QRect());
...
protected:
    ...
    void visitColorizeMask(KisColorizeMask *mask, KisUndoAdapter *undoAdapter) { Q_UNUSED(mask); Q_UNUSED(undoAdapter); }
private:
