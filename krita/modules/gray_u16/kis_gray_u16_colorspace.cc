...
KisGrayU16ColorSpace::KisGrayU16ColorSpace() :
    KisU16BaseColorSpace(KisID("GRAYA16", i18n("GRAY/Alpha (16-bit integer/channel)")), TYPE_GRAYA_16, icSigGrayData)
{
    ...
    cmsFreeGamma(Gamma);
    setDefaultProfile( new KisProfile(hProfile, TYPE_GRAYA_16) );
...
bool KisGrayU16ColorSpace::hasAlpha() const
{
    return true;
}

Q_INT32 KisGrayU16ColorSpace::nChannels() const
{
    return MAX_CHANNEL_GRAYA;
}

Q_INT32 KisGrayU16ColorSpace::nColorChannels() const
{
    return MAX_CHANNEL_GRAY;
}

Q_INT32 KisGrayU16ColorSpace::pixelSize() const
{
