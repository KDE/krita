...
#ifndef KIS_TOOL_CURVE_PAINT_H_
#define KIS_TOOL_CURVE_PAINT_H_
...
class KisToolCurvePaint : public KisToolCurve {

    typedef KisToolCurve super;
    Q_OBJECT

public:
    KisToolCurvePaint(const QString& UIName);
    virtual ~KisToolCurvePaint();
