...
# XXX: CMake's logic here is wrong, it assumes Windows == MSVC *and*
# that the library will always be built dynamically
# if(WIN32)
...
if(WIN32)
  if (MSVC)
    string( REGEX REPLACE ".lib$" ".dll" GSL_LIBRARY_DLL       "${GSL_LIBRARY}" )
    string( REGEX REPLACE ".lib$" ".dll" GSL_CBLAS_LIBRARY_DLL "${GSL_CBLAS_LIBRARY}" )
    string( REGEX REPLACE ".lib$" ".dll" GSL_LIBRARY_DEBUG_DLL "${GSL_LIBRARY_DEBUG}" )
    string( REGEX REPLACE ".lib$" ".dll" GSL_CBLAS_LIBRARY_DEBUG_DLL "${GSL_CBLAS_LIBRARY_DEBUG}" )
  elseif ("${GSL_LIBRARY}" MATCHES "\.dll\.a$")
    string( REGEX REPLACE ".a$" "" GSL_LIBRARY_DLL       "${GSL_LIBRARY}" )
    string( REGEX REPLACE ".a$" "" GSL_CBLAS_LIBRARY_DLL "${GSL_CBLAS_LIBRARY}" )
    string( REGEX REPLACE ".a$" "" GSL_LIBRARY_DEBUG_DLL "${GSL_LIBRARY_DEBUG}" )
    string( REGEX REPLACE ".a$" "" GSL_CBLAS_LIBRARY_DEBUG_DLL "${GSL_CBLAS_LIBRARY_DEBUG}" )
  else()
    string( REGEX REPLACE ".a$" ".dll" GSL_LIBRARY_DLL       "${GSL_LIBRARY}" )
    string( REGEX REPLACE ".a$" ".dll" GSL_CBLAS_LIBRARY_DLL "${GSL_CBLAS_LIBRARY}" )
    string( REGEX REPLACE ".a$" ".dll" GSL_LIBRARY_DEBUG_DLL "${GSL_LIBRARY_DEBUG}" )
    string( REGEX REPLACE ".a$" ".dll" GSL_CBLAS_LIBRARY_DEBUG_DLL "${GSL_CBLAS_LIBRARY_DEBUG}" )
  endif()
endif()
