...
TelemetryPresetsSource::TelemetryPresetsSource()
    : AbstractDataSource(QStringLiteral("Presets"), Provider::DetailedSystemInformation)
{
}

QString TelemetryPresetsSource::description() const
{
    return QObject::tr("The informtion about presets");
}

QVariant TelemetryPresetsSource::data()
{
    m_imageDumps.clear();
