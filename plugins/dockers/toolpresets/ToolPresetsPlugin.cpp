...
class ToolPresetsDockerDockFactory : public KoDockFactoryBase
{
public:
    ToolPresetsDockerDockFactory()
    {
    }

    QString id() const override
    {
        return QStringLiteral("ToolPresetsDocker");
    }
...
ToolPresetsPlugin::ToolPresetsPlugin(QObject *parent, const QVariantList &)
    : QObject(parent)
{
    KoDockRegistry::instance()->add(new ToolPresetsDockerDockFactory());
}
