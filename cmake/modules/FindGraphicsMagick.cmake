...
#
#  GRAPHICSMAGICK_INCLUDE_DIR, Where to find the GraphicMagick headers.
...
set(GRAPHICSMAGICK_FOUND FALSE)
   ...
   if(GRAPHICSMAGICK_INCLUDE_DIR AND GRAPHICSMAGICK_LIBRARIES AND GRAPHICSMAGICK_VERSION)
      set(GRAPHICSMAGICK_FOUND TRUE)
   endif(GRAPHICSMAGICK_INCLUDE_DIR AND GRAPHICSMAGICK_LIBRARIES AND GRAPHICSMAGICK_VERSION)

if(GRAPHICSMAGICK_FOUND)
   set(HAVE_GMAGICK 1)
   if(NOT GRAPHICSMAGICK_FIND_QUIETLY)
      message(STATUS "Found Graphics Magick version ${GRAPHICSMAGICK_VERSION}: ${GRAPHICSMAGICK_LIBRARIES} ${GRAPHICSMAGICK_INCLUDE_DIR}")
