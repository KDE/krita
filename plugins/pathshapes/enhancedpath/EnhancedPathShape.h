...
private:
    ...
    // of the shape is preserved after stretching.
    // It is needed for example in round-rectangles to have the corners round after stretching, without it
    // the corners would be eliptical.
