...
#ifndef __rdf_RdfSemanticItem_h__
#define __rdf_RdfSemanticItem_h__
...
protected:
     ...
     */
    Soprano::Node createNewUUIDNode();
...
public:
     ...
     * reference to a semantic item, use RdfSemanticItemViewSite::stylesheet()
     *
     * @see RdfSemanticItemViewSite
     * @see RdfSemanticItemViewSite::stylesheet()
     */
    SemanticStylesheet *defaultStylesheet();
    /**
     ...
     * semantic item, use RdfSemanticItemViewSite::applyStylesheet().
     * @see RdfSemanticItemViewSite::applyStylesheet()
     */
    void defaultStylesheet(SemanticStylesheet *ss);
     ...
     */
    void destroyUserStylesheet(SemanticStylesheet *ss);
