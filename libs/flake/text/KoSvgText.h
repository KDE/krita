...
enum TextTransform {
    ...
    TextTransformCapitalize, ///< Convert first letter in word of bicarmel text
                             ///< to upper-case, locale dependant.
    TextTransformUppercase, ///< Convert all bicarmel text to upper-case, locale
                            ///< dependant.
    TextTransformLowercase, ///< Convert all bicarmel text to lower-case, locale
                            ///< dependant.
    TextTransformFullWidth, ///< Convert proportional or half-width text to
                            ///< full-width text.
    TextTransformFullSizeKana ///< Convert Japanese Katakana and Hiragana to
                              ///< their 'fullsize' equivelants.
};
