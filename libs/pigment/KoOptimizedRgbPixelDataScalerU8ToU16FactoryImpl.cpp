...
KoOptimizedRgbPixelDataScalerU8ToU16Base *KoOptimizedRgbPixelDataScalerU8ToU16FactoryImpl::create(int)
{
    return new KoOptimizedRgbPixelDataScalerU8ToU16<_impl>();
}
