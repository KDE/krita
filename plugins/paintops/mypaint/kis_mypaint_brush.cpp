...
bool KisMyPaintBrush::load(KisResourcesInterfaceSP resourcesInterface) {
...
KoResourceSP KisMyPaintBrush::clone() const {

    KisMyPaintBrush brush = *this;
    KoResourceSP brushSP(&brush);
    return brushSP;
}

QPair<QString, QString> KisMyPaintBrush::resourceType() const {

    return QPair<QString, QString>(ResourceType::MyPaintBrushes, "");
}
