...
KisPaintOp * KisTemplateOpFactory::createOp(KisPainter * painter)
{
    KisPaintOp * op = new KisTemplateOp(painter);
    Q_CHECK_PTR(op);
    return op;
}

KisTemplateOp::KisTemplateOp(KisPainter * painter)
    : super(painter)
{
}

KisTemplateOp::~KisTemplateOp()
{
}

void KisTemplateOp::paintAt(const KisPoint &pos,
