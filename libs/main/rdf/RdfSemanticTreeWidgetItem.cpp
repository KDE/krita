...
public:
    ...
    RdfSemanticTreeWidgetApplyStylesheet(QWidget *parent, KoCanvasBase *canvas,
            const QString &name, RdfSemanticItem *si, SemanticStylesheet *ss = 0);
...
RdfSemanticTreeWidgetApplyStylesheet::RdfSemanticTreeWidgetApplyStylesheet(QWidget *parent,
        KoCanvasBase *canvas, const QString &name, RdfSemanticItem* si, SemanticStylesheet *ss )
...
void RdfSemanticTreeWidgetItem::addApplyStylesheetActions(QWidget *parent,
