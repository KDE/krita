...
KisMergeLabeledLayersCommand::KisMergeLabeledLayersCommand(KisImageSP refImage, KisPaintDeviceSP refPaintDevice, KisNodeSP currentRoot)
...
void KisMergeLabeledLayersCommand::mergeLabeledLayers()
{
    ...
    KisLayerUtils::recursiveApplyNodes(m_currentRoot, [&nodesList, refImage] (KisNodeSP node) mutable {
