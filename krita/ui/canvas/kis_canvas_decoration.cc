...
void KisCanvasDecoration::paint(QPainter& gc, const QRect& area, const KoViewConverter &converter)
{
    if(visible())
    {
        dbgKrita << "Decoration is visible";
        drawDecoration(gc, area, converter);
    }
}
