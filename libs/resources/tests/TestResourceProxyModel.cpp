 ...
 */
#include "TestResourceProxyModel.h"
...
void TestResourceProxyModel::initTestCase()
{
...
void TestResourceProxyModel::testRowCount()
{
    QSqlQuery q;
...
void TestResourceProxyModel::cleanupTestCase()
{
...
QTEST_MAIN(TestResourceProxyModel)
