...
class KRITACOLOR_EXPORT KisRgbU16ColorSpace : public KoU16ColorSpaceTrait, public KoLcmsColorSpaceTrait {
public:
...
class KisRgbU16ColorSpaceFactory : public KoColorSpaceFactory
{
public:
    /**
