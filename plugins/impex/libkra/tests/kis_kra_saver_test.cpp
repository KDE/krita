...
void KisKraSaverTest::testRoundTripColorizeMask()
{
...

    {
        ...
        mask->addKeyStroke(key1, KoColor(Qt::green, layer1->colorSpace()));
...

    {
        ...
        mask->addKeyStroke(key2, KoColor(Qt::red, layer1->colorSpace()));
...

    {
        ...
        mask->addKeyStroke(key3, KoColor(Qt::blue, layer1->colorSpace()), true);
