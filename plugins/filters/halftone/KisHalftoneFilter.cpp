...
KisFilterConfigurationSP KisHalftoneFilter::defaultConfiguration() const
{
    KisHalftoneFilterConfigurationSP filterConfig =
        dynamic_cast<KisHalftoneFilterConfiguration*>(factoryConfiguration().data());
    ...
    if (defaultGenerator) {
        KisFilterConfigurationSP defaultGeneratorConfiguration =
            defaultGenerator->defaultConfiguration();
...
{
    return new KisHalftoneFilterConfiguration("halftone", 1);
}
