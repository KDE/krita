...
#ifndef _KIS_PAINTOP_BOX_H_
#define _KIS_PAINTOP_BOX_H_
...
/**
 * The paintop box is a toolbox that contains all
 ...
 * painter's chest.
 */
class KisPaintOpBox : public KisBaseDocker {
...
public:
	...
	KisPaintOpBox(QWidget * parent = 0, const char * name = 0);
	virtual ~KisPaintOpBox();
