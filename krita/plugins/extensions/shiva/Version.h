...
#define OPENSHIVA_16_OR_MORE KDE_MAKE_VERSION(OPENSHIVA_VERSION_MAJOR, OPENSHIVA_VERSION_MINOR, OPENSHIVA_VERSION_REVISION) >= KDE_MAKE_VERSION(0, 9, 16)

#ifdef OPENSHIVA_16_OR_MORE
#define METADATA_HEADER <GTLFragment/Metadata.h>
#else
#define METADATA_HEADER <OpenShiva/Metadata.h>
#endif
