    ...
    : QObject(parent)
{
    ...
    r->add(new KisSimplePaintOpFactory<KisHairyPaintOp, KisHairyPaintOpSettings, KisHairyPaintOpSettingsWidget>("hairybrush", i18n("Hairy"), KisPaintOpFactory::categoryStable(), "krita-sumi.png"));
