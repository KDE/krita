...
QString KisStrategyColorSpaceCMYKA::channelValueText(const Q_UINT8 *pixel, Q_UINT32 channelIndex) const
{
...
QString KisStrategyColorSpaceCMYKA::normalisedChannelValueText(const Q_UINT8 *pixel, Q_UINT32 channelIndex) const
{
	Q_ASSERT(channelIndex < nChannels());
	Q_UINT32 channelPosition = m_channels[channelIndex] -> pos();
