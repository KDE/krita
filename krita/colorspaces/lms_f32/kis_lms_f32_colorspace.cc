...
{
    m_channels.push_back(new KisChannelInfo(i18n("Long"), PIXEL_LONGWAVE * sizeof(float), COLOR, sizeof(float)));
    m_channels.push_back(new KisChannelInfo(i18n("Middle"), PIXEL_MIDDLEWAVE * sizeof(float), COLOR, sizeof(float)));
    m_channels.push_back(new KisChannelInfo(i18n("Short"), PIXEL_SHORTWAVE * sizeof(float), COLOR, sizeof(float)));
...
void KisLmsF32ColorSpace::fromQColor(const QColor& c, Q_UINT8 *dstU8)
{
...
void KisLmsF32ColorSpace::fromQColor(const QColor& c, Q_UINT8 opacity, Q_UINT8 *dstU8)
{
    Pixel *dst = reinterpret_cast<Pixel *>(dstU8);
...
void KisLmsF32ColorSpace::toQColor(const Q_UINT8 *srcU8, QColor *c)
{
...
void KisLmsF32ColorSpace::toQColor(const Q_UINT8 *srcU8, QColor *c, Q_UINT8 *opacity)
{
   const Pixel *src = reinterpret_cast<const Pixel *>(srcU8);
...
Q_INT8 KisLmsF32ColorSpace::difference(const Q_UINT8 *src1U8, const Q_UINT8 *src2U8)
{
...
bool KisLmsF32ColorSpace::hasAlpha() const
{
    return true;
}

Q_INT32 KisLmsF32ColorSpace::nChannels() const
{
    return MAX_CHANNEL_LMSA;
}

Q_INT32 KisLmsF32ColorSpace::nColorChannels() const
{
    return MAX_CHANNEL_LMS;
}

Q_INT32 KisLmsF32ColorSpace::pixelSize() const
{
