...
KisIteratorPixelMask::KisIteratorPixelMask( KisPaintDeviceSP ndevice, KisTileCommand* command, Q_INT32 nypos, Q_INT32 nxpos) :
...
KisIteratorLinePixelMask::KisIteratorLinePixelMask( KisPaintDeviceSP ndevice, KisTileCommand* command, Q_INT32 nypos,
						Q_INT32 nxstart, Q_INT32 nxend) :
	KisIteratorLine<KisIteratorPixel>( ndevice, command, nypos, nxstart, nxend)
{
}

KisIteratorPixel KisIteratorLinePixelMask::operator*()
{
	return KisIteratorPixel(new KisIteratorPixelMask( m_device, m_command, m_ypos, m_xstart ));
}
KisIteratorLinePixelMask::operator KisIteratorPixel* ()
{
