...
{
    KisSelectionSP pixelSelection = new KisSelection(KisDefaultBounds(paintDevice));
...
{
    KisSelectionSP vectorSelection = new KisSelection(KisDefaultBounds(paintDevice));
