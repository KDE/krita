...
KisTiledRandomAccessor::KisTiledRandomAccessor(KisDataManager *ktm, qint32 x, qint32 y, bool writable) :
        m_ktm(ktm),
...
#else
    kti->data = kti->tile->m_tileData->data; // ### OMFGZOR Naughty Cyrille!
#endif
...
#else
    kti->oldData = kti->oldtile->m_tileData->data;
#endif
    return kti;
}
