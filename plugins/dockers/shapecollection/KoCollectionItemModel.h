...
/**
 * Struct containing the information stored in KoCollectionItemModel item
 */
...
class KoCollectionItemModel : public QAbstractListModel
{
    Q_OBJECT
    public:
        KoCollectionItemModel(QObject* parent = 0);
