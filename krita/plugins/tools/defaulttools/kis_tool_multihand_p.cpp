...
FreehandPaintJob::FreehandPaintJob(KisToolMultihand* toolFreeHand,
                                   KisPainter* painter,
...
FreehandPaintAtJob::FreehandPaintAtJob(KisToolMultihand* toolFreeHand,
                                       KisPainter* painter,
...
FreehandPaintLineJob::FreehandPaintLineJob(KisToolMultihand* toolFreeHand,
        KisPainter* painter,
        const KisPaintInformation & pi1,
        const KisPaintInformation & pi2,
        const FreehandPaintJob* previousPaintJob)
...
FreehandPaintBezierJob::FreehandPaintBezierJob(KisToolMultihand* toolFreeHand,
        KisPainter* painter,
        const KisPaintInformation & pi1,
