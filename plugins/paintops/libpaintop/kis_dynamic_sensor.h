...
const KoID FuzzyPerDabId("fuzzy", ki18ncc("Context: dynamic sensors", "Fuzzy Dab")); ///< generate a random number
const KoID FuzzyPerStrokeId("fuzzystroke", ki18ncc("Context: dynamic sensors", "Fuzzy Stroke")); ///< generate a random number
const KoID SpeedId("speed", ki18ncc("Context: dynamic sensors", "Speed")); ///< generate a number depending on the speed of the cursor
...
const KoID DistanceId("distance", ki18ncc("Context: dynamic sensors", "Distance")); ///< generate a number that increase with distance
const KoID TimeId("time", ki18ncc("Context: dynamic sensors", "Time")); ///< generate a number that increase with time
const KoID DrawingAngleId("drawingangle", ki18ncc("Context: dynamic sensors", "Drawing angle")); ///< number depending on the angle
const KoID RotationId("rotation", ki18ncc("Context: dynamic sensors", "Rotation")); ///< rotation coming from the device
const KoID PressureId("pressure", ki18ncc("Context: dynamic sensors", "Pressure")); ///< number depending on the pressure
const KoID PressureInId("pressurein", ki18ncc("Context: dynamic sensors", "PressureIn")); ///< number depending on the pressure
const KoID XTiltId("xtilt", ki18ncc("Context: dynamic sensors", "X-Tilt")); ///< number depending on X-tilt
const KoID YTiltId("ytilt", ki18ncc("Context: dynamic sensors", "Y-Tilt")); ///< number depending on Y-tilt
 ...
 * differently.
 */
const KoID TiltDirectionId("ascension", ki18ncc("Context: dynamic sensors", "Tilt direction")); /// < number depending on the X and Y tilt, tilt direction is 0 when stylus nib points to you and changes clockwise from -180 to +180.
const KoID TiltElevationId("declination", ki18ncc("Context: dynamic sensors", "Tilt elevation")); /// < tilt elevation is 90 when stylus is perpendicular to tablet and 0 when it's parallel to tablet

const KoID PerspectiveId("perspective", ki18ncc("Context: dynamic sensors", "Perspective")); ///< number depending on the distance on the perspective grid
const KoID TangentialPressureId("tangentialpressure", ki18ncc("Context: dynamic sensors", "Tangential pressure")); ///< the wheel on an airbrush device
