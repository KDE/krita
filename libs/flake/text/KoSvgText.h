...
enum OverflowWrap {
    OverflowWrapNormal,   ///< Do nothing besides 'relaxing' the strictness of 'wordbreak'.
    OverflowWrapAnywhere, ///< Break anywhere as soon as overflow happens.
    OverflowWrapBreakWord ///< Break previous soft-break before breaking the word.
};
...
struct AssociatedShapeWrapper : public KoShape::ShapeChangeListener
{
    ...
    KoSvgTextChunkShape *shape() { return m_shape; }
