...
template<class T>
struct CFHardMixPhotoshop : ClampedSourceAndDestinationCompositeFunctorBase<T> {
    static inline T composeChannel(T src, T dst) {
        using namespace Arithmetic;
        typedef typename KoColorSpaceMathsTraits<T>::compositetype composite_type;
...
template<class T>
struct CFHardMixSofterPhotoshop : ClampedSourceAndDestinationCompositeFunctorBase<T> {
    static inline T composeChannel(T src, T dst) {
        using namespace Arithmetic;
        typedef typename KoColorSpaceMathsTraits<T>::compositetype composite_type;
