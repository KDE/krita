 ...
 */
#ifndef KIS_TOOL_MULTIHAND_P_H
#define KIS_TOOL_MULTIHAND_P_H
...
public:
    ...
    FreehandPaintJob(KisToolMultihand* freeHand,
                     KisPainter* painter,
...
protected:
    ...
    KisToolMultihand* m_toolFreeHand;
...
public:
    ...
    FreehandPaintAtJob(KisToolMultihand* freeHand,
                       KisPainter* painter,
...
public:
    ...
    FreehandPaintLineJob(KisToolMultihand* freeHand,
                         KisPainter* painter,
                         const KisPaintInformation & pi1,
                         const KisPaintInformation & pi2,
                         const FreehandPaintJob* previousPaintJob);
...
public:
    ...
    FreehandPaintBezierJob(KisToolMultihand* freeHand,
                           KisPainter* painter,
                           const KisPaintInformation & pi1,
