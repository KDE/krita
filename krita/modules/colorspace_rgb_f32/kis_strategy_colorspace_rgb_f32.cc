...
KisStrategyColorSpaceRGBF32::KisStrategyColorSpaceRGBF32() :
	KisStrategyColorSpace(KisID("RGBAF32", i18n("RGB/Alpha (32-bit float/channel)")), F32_LCMS_TYPE, icSigRgbData)
{
...
void KisStrategyColorSpaceRGBF32::setPixel(Q_UINT8 *dst, float red, float green, float blue, float alpha) const
{
...
void KisStrategyColorSpaceRGBF32::getPixel(const Q_UINT8 *src, float *red, float *green, float *blue, float *alpha) const
{
...
void KisStrategyColorSpaceRGBF32::nativeColor(const QColor& c, Q_UINT8 *dstU8, KisProfileSP /*profile*/)
{
...
void KisStrategyColorSpaceRGBF32::nativeColor(const QColor& c, QUANTUM opacity, Q_UINT8 *dstU8, KisProfileSP /*profile*/)
{
	Pixel *dst = reinterpret_cast<Pixel *>(dstU8);
...
void KisStrategyColorSpaceRGBF32::getAlpha(const Q_UINT8 *U8_pixel, Q_UINT8 *alpha)
{
	const Pixel *pixel = reinterpret_cast<const Pixel *>(U8_pixel);
	*alpha = FLOAT_TO_UINT8(pixel -> alpha);
}

void KisStrategyColorSpaceRGBF32::setAlpha(Q_UINT8 *pixels, Q_UINT8 alpha, Q_INT32 nPixels)
{
...
void KisStrategyColorSpaceRGBF32::toQColor(const Q_UINT8 *srcU8, QColor *c, KisProfileSP /*profile*/)
{
...
void KisStrategyColorSpaceRGBF32::toQColor(const Q_UINT8 *srcU8, QColor *c, QUANTUM *opacity, KisProfileSP /*profile*/)
{
	const Pixel *src = reinterpret_cast<const Pixel *>(srcU8);
...
Q_INT8 KisStrategyColorSpaceRGBF32::difference(const Q_UINT8 *src1U8, const Q_UINT8 *src2U8)
{
...
void KisStrategyColorSpaceRGBF32::mixColors(const Q_UINT8 **colors, const Q_UINT8 *weights, Q_UINT32 nColors, Q_UINT8 *dst) const
{
...
vKisChannelInfoSP KisStrategyColorSpaceRGBF32::channels() const
{
	return m_channels;
}

bool KisStrategyColorSpaceRGBF32::hasAlpha() const
{
	return true;
}

Q_INT32 KisStrategyColorSpaceRGBF32::nChannels() const
{
	return MAX_CHANNEL_RGBA;
}

Q_INT32 KisStrategyColorSpaceRGBF32::nColorChannels() const
{
	return MAX_CHANNEL_RGB;
}

Q_INT32 KisStrategyColorSpaceRGBF32::pixelSize() const
{
...
void KisStrategyColorSpaceRGBF32::adjustBrightnessContrast(const Q_UINT8 *src, Q_UINT8 *dst, Q_INT8 brightness, Q_INT8 contrast, Q_INT32 nPixels) const
{
	/*
...
void KisStrategyColorSpaceRGBF32::compositeOver(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	while (rows > 0) {
...
void KisStrategyColorSpaceRGBF32::compositeMultiply(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
...
void KisStrategyColorSpaceRGBF32::compositeDivide(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeScreen(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeOverlay(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeDodge(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeBurn(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeDarken(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeLighten(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeHue(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeSaturation(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeValue(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeColor(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, float opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisStrategyColorSpaceRGBF32::compositeErase(Q_UINT8 *dst, 
		    Q_INT32 dstRowSize,
		    const Q_UINT8 *src, 
		    Q_INT32 srcRowSize,
...
void KisStrategyColorSpaceRGBF32::compositeCopy(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, 
...
void KisStrategyColorSpaceRGBF32::bitBlt(Q_UINT8 *dst,
...
KisCompositeOpList KisStrategyColorSpaceRGBF32::userVisiblecompositeOps() const
{
...
QString KisStrategyColorSpaceRGBF32::channelValueText(const Q_UINT8 *U8_pixel, Q_UINT32 channelIndex) const
{
...
QString KisStrategyColorSpaceRGBF32::normalisedChannelValueText(const Q_UINT8 *U8_pixel, Q_UINT32 channelIndex) const
{
