 ...
 * Cursors are encoded as Xbitmap. A reference for modification is in krita/data/cursors/pickerCursor.xbm
 */
...
QCursor KisCursor::pickerCursor()
{
	...
	0x00, 0xc8, 0x01, 0x00, 0x40, 0xe4, 0x00, 0x00, 0x40, 0x74, 0x00, 0x00,
    ...
    QBitmap picker_bitmap = bitmapFromData(QSize(32, 32), picker_bits);
