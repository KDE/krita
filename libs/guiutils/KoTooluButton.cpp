...
void KoColorPanel::insertDefaultColors()
{
    ...
    insertColor(QColor( 255 ,     0 ,     0 ), i18nc( "color", "Red" ), false);
    insertColor(QColor( 255 ,   165 ,     0 ), i18nc( "color", "Orange" ), false);
    insertColor(QColor( 255 ,     0 ,   255 ), i18nc( "color", "Magenta" ), false);
    insertColor(QColor(   0 ,     0 ,   255 ), i18nc( "color", "Blue" ), false);
    insertColor(QColor(   0 ,   255 ,   255 ), i18nc( "color", "Cyan" ), false);
    insertColor(QColor(   0 ,   255 ,     0 ), i18nc( "color", "Green" ), false);
    insertColor(QColor( 255 ,   255 ,     0 ), i18nc( "color", "Yellow" ), false);
    insertColor(QColor( 165 ,    42 ,    42 ), i18nc( "color", "Brown" ), false);
    insertColor(QColor( 139 ,     0 ,     0 ), i18nc( "color", "DarkRed" ), false);
    insertColor(QColor( 255 ,   140 ,     0 ), i18nc( "color", "DarkOrange" ), false);
    insertColor(QColor( 139 ,     0 ,   139 ), i18nc( "color", "DarkMagenta" ), false);
    insertColor(QColor(   0 ,     0 ,   139 ), i18nc( "color", "DarkBlue" ), false);
    insertColor(QColor(   0 ,   139 ,   139 ), i18nc( "color", "DarkCyan" ), false);
    insertColor(QColor(   0 ,   100 ,     0 ), i18nc( "color", "DarkGreen" ), false);
    insertColor(QColor( 130 ,   127 ,     0 ), i18nc( "color", "DarkYellow" ), false);
    insertColor(QColor( 255 ,   255 ,   255 ), i18nc( "color", "White" ), false);
    // xgettext:no-c-format
    insertColor(QColor( 229 ,   229 ,   229 ), i18nc( "color", "Gray 90%" ), false);
    // xgettext:no-c-format
    insertColor(QColor( 204 ,   204 ,   204 ), i18nc( "color", "Gray 80%" ), false);
    // xgettext:no-c-format
    insertColor(QColor( 178 ,   178 ,   178 ), i18nc( "color", "Gray 70%" ), false);
    // xgettext:no-c-format
    insertColor(QColor( 153 ,   153 ,   153 ), i18nc( "color", "Gray 60%" ), false);
    // xgettext:no-c-format
    insertColor(QColor( 127 ,   127 ,   127 ), i18nc( "color", "Gray 50%" ), false);
    // xgettext:no-c-format
    insertColor(QColor( 102 ,   102 ,   102 ), i18nc( "color", "Gray 40%" ), false);
    // xgettext:no-c-format
    insertColor(QColor(  76 ,    76 ,    76 ), i18nc( "color", "Gray 30%" ), false);
    // xgettext:no-c-format
    insertColor(QColor(  51 ,    51 ,    51 ), i18nc( "color", "Gray 20%" ), false);
    // xgettext:no-c-format
    insertColor(QColor(  25 ,    25 ,    25 ), i18nc( "color", "Gray 10%" ), false);
    insertColor(QColor(   0 ,     0 ,     0 ), i18nc( "color", "Black" ), false);
    insertColor(QColor( 255 ,   255 ,   240 ), i18nc( "color", "Ivory" ), false);
    insertColor(QColor( 255 ,   250 ,   250 ), i18nc( "color", "Snow" ), false);
    insertColor(QColor( 245 ,   255 ,   250 ), i18nc( "color", "MintCream" ), false);
    insertColor(QColor( 255 ,   250 ,   240 ), i18nc( "color", "FloralWhite" ), false);
    insertColor(QColor( 255 ,   255 ,   224 ), i18nc( "color", "LightYellow" ), false);
    insertColor(QColor( 240 ,   255 ,   255 ), i18nc( "color", "Azure" ), false);
    insertColor(QColor( 248 ,   248 ,   255 ), i18nc( "color", "GhostWhite" ), false);
    insertColor(QColor( 240 ,   255 ,   240 ), i18nc( "color", "Honeydew" ), false);
    insertColor(QColor( 255 ,   245 ,   238 ), i18nc( "color", "Seashell" ), false);
    insertColor(QColor( 240 ,   248 ,   255 ), i18nc( "color", "AliceBlue" ), false);
    insertColor(QColor( 255 ,   248 ,   220 ), i18nc( "color", "Cornsilk" ), false);
    insertColor(QColor( 255 ,   240 ,   245 ), i18nc( "color", "LavenderBlush" ), false);
    insertColor(QColor( 253 ,   245 ,   230 ), i18nc( "color", "OldLace" ), false);
    insertColor(QColor( 245 ,   245 ,   245 ), i18nc( "color", "WhiteSmoke" ), false);
    insertColor(QColor( 255 ,   250 ,   205 ), i18nc( "color", "LemonChiffon" ), false);
    insertColor(QColor( 224 ,   255 ,   255 ), i18nc( "color", "LightCyan" ), false);
    insertColor(QColor( 250 ,   250 ,   210 ), i18nc( "color", "LightGoldenrodYellow" ), false);
    insertColor(QColor( 250 ,   240 ,   230 ), i18nc( "color", "Linen" ), false);
    insertColor(QColor( 245 ,   245 ,   220 ), i18nc( "color", "Beige" ), false);
    insertColor(QColor( 255 ,   239 ,   213 ), i18nc( "color", "PapayaWhip" ), false);
    insertColor(QColor( 255 ,   235 ,   205 ), i18nc( "color", "BlanchedAlmond" ), false);
    insertColor(QColor( 250 ,   235 ,   215 ), i18nc( "color", "AntiqueWhite" ), false);
    insertColor(QColor( 255 ,   228 ,   225 ), i18nc( "color", "MistyRose" ), false);
    insertColor(QColor( 230 ,   230 ,   250 ), i18nc( "color", "Lavender" ), false);
    insertColor(QColor( 255 ,   228 ,   196 ), i18nc( "color", "Bisque" ), false);
    insertColor(QColor( 255 ,   228 ,   181 ), i18nc( "color", "Moccasin" ), false);
    insertColor(QColor( 255 ,   222 ,   173 ), i18nc( "color", "NavajoWhite" ), false);
    insertColor(QColor( 255 ,   218 ,   185 ), i18nc( "color", "PeachPuff" ), false);
    insertColor(QColor( 238 ,   232 ,   170 ), i18nc( "color", "PaleGoldenrod" ), false);
    insertColor(QColor( 245 ,   222 ,   179 ), i18nc( "color", "Wheat" ), false);
    insertColor(QColor( 220 ,   220 ,   220 ), i18nc( "color", "Gainsboro" ), false);
    insertColor(QColor( 240 ,   230 ,   140 ), i18nc( "color", "Khaki" ), false);
    insertColor(QColor( 175 ,   238 ,   238 ), i18nc( "color", "PaleTurquoise" ), false);
    insertColor(QColor( 255 ,   192 ,   203 ), i18nc( "color", "Pink" ), false);
    insertColor(QColor( 238 ,   221 ,   130 ), i18nc( "color", "LightGoldenrod" ), false);
    insertColor(QColor( 211 ,   211 ,   211 ), i18nc( "color", "LightGray" ), false);
    insertColor(QColor( 255 ,   182 ,   193 ), i18nc( "color", "LightPink" ), false);
    insertColor(QColor( 176 ,   224 ,   230 ), i18nc( "color", "PowderBlue" ), false);
    insertColor(QColor( 127 ,   255 ,   212 ), i18nc( "color", "Aquamarine" ), false);
    insertColor(QColor( 216 ,   191 ,   216 ), i18nc( "color", "Thistle" ), false);
    insertColor(QColor( 173 ,   216 ,   230 ), i18nc( "color", "LightBlue" ), false);
    insertColor(QColor( 152 ,   251 ,   152 ), i18nc( "color", "PaleGreen" ), false);
    insertColor(QColor( 255 ,   215 ,     0 ), i18nc( "color", "Gold" ), false);
    insertColor(QColor( 173 ,   255 ,    47 ), i18nc( "color", "GreenYellow" ), false);
    insertColor(QColor( 176 ,   196 ,   222 ), i18nc( "color", "LightSteelBlue" ), false);
    insertColor(QColor( 144 ,   238 ,   144 ), i18nc( "color", "LightGreen" ), false);
    insertColor(QColor( 221 ,   160 ,   221 ), i18nc( "color", "Plum" ), false);
    insertColor(QColor( 190 ,   190 ,   190 ), i18nc( "color", "Gray" ), false);
    insertColor(QColor( 222 ,   184 ,   135 ), i18nc( "color", "BurlyWood" ), false);
    insertColor(QColor( 135 ,   206 ,   250 ), i18nc( "color", "LightSkyBlue" ), false);
    insertColor(QColor( 255 ,   160 ,   122 ), i18nc( "color", "LightSalmon" ), false);
    insertColor(QColor( 135 ,   206 ,   235 ), i18nc( "color", "SkyBlue" ), false);
    insertColor(QColor( 210 ,   180 ,   140 ), i18nc( "color", "Tan" ), false);
    insertColor(QColor( 238 ,   130 ,   238 ), i18nc( "color", "Violet" ), false);
    insertColor(QColor( 244 ,   164 ,    96 ), i18nc( "color", "SandyBrown" ), false);
    insertColor(QColor( 233 ,   150 ,   122 ), i18nc( "color", "DarkSalmon" ), false);
    insertColor(QColor( 189 ,   183 ,   107 ), i18nc( "color", "DarkKhaki" ), false);
    insertColor(QColor( 127 ,   255 ,     0 ), i18nc( "color", "Chartreuse" ), false);
    insertColor(QColor( 169 ,   169 ,   169 ), i18nc( "color", "DarkGray" ), false);
    insertColor(QColor( 124 ,   252 ,     0 ), i18nc( "color", "LawnGreen" ), false);
    insertColor(QColor( 255 ,   105 ,   180 ), i18nc( "color", "HotPink" ), false);
    insertColor(QColor( 250 ,   128 ,   114 ), i18nc( "color", "Salmon" ), false);
    insertColor(QColor( 240 ,   128 ,   128 ), i18nc( "color", "LightCoral" ), false);
    insertColor(QColor(  64 ,   224 ,   208 ), i18nc( "color", "Turquoise" ), false);
    insertColor(QColor( 143 ,   188 ,   143 ), i18nc( "color", "DarkSeaGreen" ), false);
    insertColor(QColor( 218 ,   112 ,   214 ), i18nc( "color", "Orchid" ), false);
    insertColor(QColor( 102 ,   205 ,   170 ), i18nc( "color", "MediumAquamarine" ), false);
    insertColor(QColor( 255 ,   127 ,    80 ), i18nc( "color", "Coral" ), false);
    insertColor(QColor( 154 ,   205 ,    50 ), i18nc( "color", "YellowGreen" ), false);
    insertColor(QColor( 218 ,   165 ,    32 ), i18nc( "color", "Goldenrod" ), false);
    insertColor(QColor(  72 ,   209 ,   204 ), i18nc( "color", "MediumTurquoise" ), false);
    insertColor(QColor( 188 ,   143 ,   143 ), i18nc( "color", "RosyBrown" ), false);
    insertColor(QColor( 219 ,   112 ,   147 ), i18nc( "color", "PaleVioletRed" ), false);
    insertColor(QColor(   0 ,   250 ,   154 ), i18nc( "color", "MediumSpringGreen" ), false);
    insertColor(QColor( 255 ,    99 ,    71 ), i18nc( "color", "Tomato" ), false);
    insertColor(QColor( 0   ,   255 ,   127 ), i18nc( "color", "SpringGreen" ), false);
    insertColor(QColor( 205 ,   133 ,    63 ), i18nc( "color", "Peru" ), false);
    insertColor(QColor( 100 ,   149 ,   237 ), i18nc( "color", "CornflowerBlue" ), false);
    insertColor(QColor( 132 ,   112 ,   255 ), i18nc( "color", "LightSlateBlue" ), false);
    insertColor(QColor( 147 ,   112 ,   219 ), i18nc( "color", "MediumPurple" ), false);
    insertColor(QColor( 186 ,    85 ,   211 ), i18nc( "color", "MediumOrchid" ), false);
    insertColor(QColor(  95 ,   158 ,   160 ), i18nc( "color", "CadetBlue" ), false);
    insertColor(QColor(   0 ,   206 ,   209 ), i18nc( "color", "DarkTurquoise" ), false);
    insertColor(QColor(   0 ,   191 ,   255 ), i18nc( "color", "DeepSkyBlue" ), false);
    insertColor(QColor( 119 ,   136 ,   153 ), i18nc( "color", "LightSlateGray" ), false);
    insertColor(QColor( 184 ,   134 ,    11 ), i18nc( "color", "DarkGoldenrod" ), false);
    insertColor(QColor( 123 ,   104 ,   238 ), i18nc( "color", "MediumSlateBlue" ), false);
    insertColor(QColor( 205 ,    92 ,    92 ), i18nc( "color", "IndianRed" ), false);
    insertColor(QColor( 210 ,   105 ,    30 ), i18nc( "color", "Chocolate" ), false);
    insertColor(QColor(  60 ,   179 ,   113 ), i18nc( "color", "MediumSeaGreen" ), false);
    insertColor(QColor(  50 ,   205 ,    50 ), i18nc( "color", "LimeGreen" ), false);
    insertColor(QColor(  32 ,   178 ,   170 ), i18nc( "color", "LightSeaGreen" ), false);
    insertColor(QColor( 112 ,   128 ,   144 ), i18nc( "color", "SlateGray" ), false);
    insertColor(QColor(  30 ,   144 ,   255 ), i18nc( "color", "DodgerBlue" ), false);
    insertColor(QColor( 255 ,    69 ,     0 ), i18nc( "color", "OrangeRed" ), false);
    insertColor(QColor( 255 ,    20 ,   147 ), i18nc( "color", "DeepPink" ), false);
    insertColor(QColor(  70 ,   130 ,   180 ), i18nc( "color", "SteelBlue" ), false);
    insertColor(QColor( 106 ,    90 ,   205 ), i18nc( "color", "SlateBlue" ), false);
    insertColor(QColor( 107 ,   142 ,    35 ), i18nc( "color", "OliveDrab" ), false);
    insertColor(QColor(  65 ,   105 ,   225 ), i18nc( "color", "RoyalBlue" ), false);
    insertColor(QColor( 208 ,    32 ,   144 ), i18nc( "color", "VioletRed" ), false);
    insertColor(QColor( 153 ,    50 ,   204 ), i18nc( "color", "DarkOrchid" ), false);
    insertColor(QColor( 160 ,    32 ,   240 ), i18nc( "color", "Purple" ), false);
    insertColor(QColor( 105 ,   105 ,   105 ), i18nc( "color", "DimGray" ), false);
    insertColor(QColor( 138 ,    43 ,   226 ), i18nc( "color", "BlueViolet" ), false);
    insertColor(QColor( 160 ,    82 ,    45 ), i18nc( "color", "Sienna" ), false);
    insertColor(QColor( 199 ,    21 ,   133 ), i18nc( "color", "MediumVioletRed" ), false);
    insertColor(QColor( 176 ,    48 ,    96 ), i18nc( "color", "Maroon" ), false);
    insertColor(QColor(  46 ,   139 ,    87 ), i18nc( "color", "SeaGreen" ), false);
    insertColor(QColor(  85 ,   107 ,    47 ), i18nc( "color", "DarkOliveGreen" ), false);
    insertColor(QColor(  34 ,   139 ,    34 ), i18nc( "color", "ForestGreen" ), false);
    insertColor(QColor( 139 ,    69 ,    19 ), i18nc( "color", "SaddleBrown" ), false);
    insertColor(QColor( 148 ,     0 ,   211 ), i18nc( "color", "DarkViolet" ), false);
    insertColor(QColor( 178 ,    34 ,    34 ), i18nc( "color", "FireBrick" ), false);
    insertColor(QColor(  72 ,    61 ,   139 ), i18nc( "color", "DarkSlateBlue" ), false);
    insertColor(QColor(  47 ,    79 ,    79 ), i18nc( "color", "DarkSlateGray" ), false);
    insertColor(QColor(  25 ,    25 ,   112 ), i18nc( "color", "MidnightBlue" ), false);
    insertColor(QColor(   0 ,     0 ,   205 ), i18nc( "color", "MediumBlue" ), false);
    insertColor(QColor(   0 ,     0 ,   128 ), i18nc( "color", "Navy" ), false);
