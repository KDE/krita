...
#ifndef SIMPLETEXTSHAPEFACTORY_H
#define SIMPLETEXTSHAPEFACTORY_H
...
public:
    explicit SimpleTextShapeFactory(QObject *parent);
    ~SimpleTextShapeFactory() {}
...
#endif // SIMPLETEXTSHAPEFACTORY_H
