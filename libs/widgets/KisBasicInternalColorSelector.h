...
#include "ui_WdgBasicInternalColorSelector.h"
 ...
 */
class KRITAWIDGETS_EXPORT KisBasicInternalColorSelector : public QDialog
{
    Q_OBJECT
public:
    struct Config
    ...
    KisBasicInternalColorSelector(QWidget* parent, KoColor color, Config config, const QString &caption, const KoColorDisplayRendererInterface *displayRenderer = KoDumbColorDisplayRenderer::instance());
    ~KisBasicInternalColorSelector() override;
...
protected:
     ...
     */
    virtual void updateAllElements(QObject *source);
...
protected:
     ...
     */
    Ui_WdgBasicInternalColorSelector *m_ui;
