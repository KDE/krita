...
namespace KisStandardAction
{
   ...
   */
  KRITAUI_EXPORT KAction* create(StandardAction id, const QObject *receiver, const char *slot, QObject *parent);
   ...
   */
  KRITAUI_EXPORT KToggleAction *showGuides(const QObject *receiver, const char *slot, QObject *parent);
}
