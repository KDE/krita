	...
	: KParts::Plugin(parent, name)
{
	...
	{
		m_StrategyColorSpaceTestCS = new KisStrategyColorSpaceTestCS();
		Q_CHECK_PTR(m_StrategyColorSpaceTestCS);
		KisColorSpaceRegistry::instance() -> add(m_StrategyColorSpaceTestCS);
	}
