  ...
  : QWidget(parent, name), usingFixed(onlyFixed)
{
  ...
  familyListBox->setWhatsThis( fontFamilyWhatsThisText );
  if(diff)
	((QWidget *) familyCheckbox)->setWhatsThis( fontFamilyWhatsThisText );
  else
	((QWidget *) familyLabel)->setWhatsThis( fontFamilyWhatsThisText );
  ...
  styleListBox->setWhatsThis( fontStyleWhatsThisText );
  if(diff)
    ((QWidget *)sizeCheckbox)->setWhatsThis( fontStyleWhatsThisText );
  else
    ((QWidget *)sizeLabel)->setWhatsThis( fontStyleWhatsThisText );
  ...
  sizeListBox->setWhatsThis( fontSizeWhatsThisText );
  if(diff)
	((QWidget *)sizeCheckbox)->setWhatsThis( fontSizeWhatsThisText );
  else
	((QWidget *)sizeLabel)->setWhatsThis( fontSizeWhatsThisText );
