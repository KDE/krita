...
void KisCommonColors::recalculate()
{
    ...
    QImage image = kisImage->projection()->createThumbnailUncached(1024, 1024, kisImage->bounds(), 1, KoColorConversionTransformation::internalRenderingIntent(), KoColorConversionTransformation::internalConversionFlags());
