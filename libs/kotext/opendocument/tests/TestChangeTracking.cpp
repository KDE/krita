...
void TestChangeTracking::testChangeTracking_data()
{
    ...
    QTest::newRow("List Item Numbering Restart Removed")  << "ChangeTracking/attributes/attribute-deletion/restarted-list-numbering-removed-tracked.odt";
    ...
    QTest::newRow("Paragraph Style Changes - 2")  << "ChangeTracking/attributes/attribute-modification/paragraph-style-change-tracked.odt";
