...
public:
    ...
    BrushSettingDefinitions()
    {
        ...
        list << new BrushSettingDefinition("speed1_slowness", i18n("speed1 filter"), false, 0.0, 0.04, 0.2, i18n("how slow the input speed1 is following the real speed\n0.0 change immediatly as your speed changes (not recommended, but try it)"));
        ...
        list << new BrushSettingDefinition("stroke_treshold", i18n("stroke treshold"), true, 0.0, 0.0, 0.5, i18n("How much pressure is needed to start a stroke. This affects the stroke input only. Mypaint does not need a minimal pressure to start drawing."));
        list << new BrushSettingDefinition("stroke_duration_logarithmic", i18n("stroke duration"), false, -1.0, 4.0, 7.0, i18n("How far you have to move until the stroke input reaches 1.0. This value is logarithmic (negative values will not inverse the process)."));
