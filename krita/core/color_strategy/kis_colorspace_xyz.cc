...
const Q_UINT16 KisColorspaceXYZ::U16_OPACITY_OPAQUE;
const Q_UINT16 KisColorspaceXYZ::U16_OPACITY_TRANSPARENT;


// XXX: Maybe use TYPE_XYZ_DBL for an extra stimulating performance hit? People shouldn't depend
//      on this fallback...

KisColorspaceXYZ::KisColorspaceXYZ() :
	KisStrategyColorSpace(KisID("XYZA", i18n("XYZ/Alpha")), TYPE_XYZ_16, icSigCmykData)
{
...
void KisColorspaceXYZ::nativeColor(const QColor& color, Q_UINT8 *dst, KisProfileSP /*profile*/)
{
...
void KisColorspaceXYZ::nativeColor(const QColor& color, QUANTUM opacity, Q_UINT8 *dst, KisProfileSP /*profile*/)
{
...
void KisColorspaceXYZ::getAlpha(const Q_UINT8 *U8_pixel, Q_UINT8 *alpha)
{
	const Pixel *pixel = reinterpret_cast<const Pixel *>(U8_pixel);
	*alpha = UINT16_TO_UINT8(pixel -> alpha);
}

void KisColorspaceXYZ::setAlpha(Q_UINT8 *pixels, Q_UINT8 alpha, Q_INT32 nPixels)
{
...
void KisColorspaceXYZ::toQColor(const Q_UINT8 *src, QColor *c, KisProfileSP /*profile*/)
{
...
void KisColorspaceXYZ::toQColor(const Q_UINT8 *src, QColor *c, QUANTUM *opacity, KisProfileSP /*profile*/)
{
	// XXX: Properly convert using the rgb colorspace and the profile
	cmsDoTransform(m_defaultToRGB, const_cast <Q_UINT8 *>(src), m_qcolordata, 1);
	c -> setRgb(m_qcolordata[2], m_qcolordata[1], m_qcolordata[0]);
...
Q_INT8 KisColorspaceXYZ::difference(const Q_UINT8 *src1, const Q_UINT8 *src2)
{
}

void KisColorspaceXYZ::mixColors(const Q_UINT8 **colors, const Q_UINT8 *weights, Q_UINT32 nColors, Q_UINT8 *dst) const
{
}

vKisChannelInfoSP KisColorspaceXYZ::channels() const
{
	return m_channels;
}

bool KisColorspaceXYZ::hasAlpha() const
{
	return true;
}

Q_INT32 KisColorspaceXYZ::nChannels() const
{
	return xyz::MAX_CHANNEL_XYZA;
}

Q_INT32 KisColorspaceXYZ::nColorChannels() const
{
	return xyz::MAX_CHANNEL_XYZ;
}

Q_INT32 KisColorspaceXYZ::pixelSize() const
{
	return xyz::MAX_CHANNEL_XYZA * sizeof(Q_UINT16);
}


QImage KisColorspaceXYZ::convertToQImage(const Q_UINT8 *data, Q_INT32 width, Q_INT32 height,
...
void KisColorspaceXYZ::adjustBrightnessContrast(const Q_UINT8 *src, Q_UINT8 *dst, Q_INT8 brightness, Q_INT8 contrast, Q_INT32 nPixels) const
{
}

void KisColorspaceXYZ::compositeOver(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	while (rows > 0) {
...
void KisColorspaceXYZ::compositeMultiply(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
...
void KisColorspaceXYZ::compositeDivide(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeScreen(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeOverlay(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeDodge(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeBurn(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeDarken(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeLighten(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride, const Q_UINT8 *maskRowStart, Q_INT32 maskRowStride, Q_INT32 rows, Q_INT32 numColumns, Q_UINT16 opacity)
{
	COMMON_COMPOSITE_OP_PROLOG();
...
void KisColorspaceXYZ::compositeErase(Q_UINT8 *dst,
		    Q_INT32 dstRowSize,
		    const Q_UINT8 *src, 
		    Q_INT32 srcRowSize,
...
void KisColorspaceXYZ::compositeCopy(Q_UINT8 *dstRowStart, Q_INT32 dstRowStride, const Q_UINT8 *srcRowStart, Q_INT32 srcRowStride,
...
void KisColorspaceXYZ::bitBlt(Q_UINT8 *dst,
...
KisCompositeOpList KisColorspaceXYZ::userVisiblecompositeOps() const
{
...
QString KisColorspaceXYZ::channelValueText(const Q_UINT8 *U8_pixel, Q_UINT32 channelIndex) const
{
...
QString KisColorspaceXYZ::normalisedChannelValueText(const Q_UINT8 *U8_pixel, Q_UINT32 channelIndex) const
{
	Q_ASSERT(channelIndex < nChannels());
	const Q_UINT16 *pixel = reinterpret_cast<const Q_UINT16 *>(U8_pixel);
	Q_UINT32 channelPosition = m_channels[channelIndex] -> pos() / sizeof(Q_UINT16);
