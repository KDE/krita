...
typedef KisTileHashTableIteratorTraits<KisMementoItem, true> KisMementoItemHashTableIterator;
typedef KisTileHashTableIteratorTraits<KisMementoItem, false> KisMementoItemHashTableIteratorConst;
