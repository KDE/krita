...
class KRITAIMAGE_EXPORT LineEquation {
    ...
    public:
        ...
        inline const qreal& a() const { return m_normal.coeff(0); }
        inline const qreal& b() const { return m_normal.coeff(1); }
        inline const qreal& c() const { return m_c; }
        inline const KisVector2D normal() const { return m_normal; }
};
