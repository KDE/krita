...
#ifndef _KIS_POLYNOMIAL_CURVE_H_
#define _KIS_POLYNOMIAL_CURVE_H_
 ...
 */
class /*KRITAIMAGE_EXPORT*/ KisPolynomialCurve : public KisCurve
{
public:
    KisPolynomialCurve();
    KisPolynomialCurve(const QList<QPointF>& points);
    KisPolynomialCurve(const QVector<QPointF>& points);
    ~KisPolynomialCurve();
    bool operator==(const KisPolynomialCurve& curve) const;
public:
