...
IF (WV2_LIBRARIES AND WV2_INCLUDE_DIR AND WV2_VERSION)
  # in cache already
  IF (WV2_VERSION STRGREATER WV2_REQUIRED OR WV2_VERSION STREQUAL WV2_REQUIRED)
    SET(WV2_FOUND TRUE)
...
ELSE (WV2_LIBRARIES AND WV2_INCLUDE_DIR AND WV2_VERSION)
  ...
  IF (WV2CONFIG_EXECUTABLE)
    ...
    IF (WV2_LIBRARIES AND WV2_INCLUDE_DIR AND WV2_VERSION)
      IF (WV2_VERSION STRGREATER WV2_REQUIRED OR WV2_VERSION STREQUAL WV2_REQUIRED)
        SET(WV2_FOUND TRUE)
      ENDIF (WV2_VERSION STRGREATER WV2_REQUIRED OR WV2_VERSION STREQUAL WV2_REQUIRED)
