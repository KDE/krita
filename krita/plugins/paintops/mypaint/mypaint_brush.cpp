...
inline void MyPaintBrush::myMovePixel(qreal newX, qreal newY, quint8 *dst){
    if (m_useBilinear){
        if (m_useOldData)
        {
...
inline void MyPaintBrush::movePixel(qreal newX, qreal newY, quint8 *dst){
    if (m_useBilinear){
...
**/
void MyPaintBrush::fastScale(qreal cursorX,qreal cursorY, qreal factor){
...
void MyPaintBrush::fastLensDistortion(qreal cursorX,qreal cursorY, qreal k1, qreal k2){
...
void MyPaintBrush::fastMove(qreal cursorX,qreal cursorY, qreal dx, qreal dy){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
...
void MyPaintBrush::fastMyPaintColor(qreal cursorX,qreal cursorY,qreal amount){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
...
void MyPaintBrush::fastSwirl(qreal cursorX,qreal cursorY, qreal alpha){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
...
**/
void MyPaintBrush::lensDistortion(qreal cursorX,qreal cursorY, qreal k1, qreal k2){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
...
void MyPaintBrush::move(qreal cursorX,qreal cursorY, qreal dx, qreal dy){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
...
void MyPaintBrush::scale(qreal cursorX,qreal cursorY, qreal factor){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
    //KoColor kcolor( m_dev->colorSpace() );
...
void MyPaintBrush::mypaintColor ( qreal cursorX,qreal cursorY,qreal amount){
    int curXi = static_cast<int> ( cursorX+0.5 );
    int curYi = static_cast<int> ( cursorY+0.5 );
...
void MyPaintBrush::swirl(qreal cursorX,qreal cursorY, qreal alpha){
    int curXi = static_cast<int>(cursorX+0.5);
    int curYi = static_cast<int>(cursorY+0.5);
...
void MyPaintBrush::paint(KisPaintDeviceSP dev,KisPaintDeviceSP layer, const KisPaintInformation &info)
{
    qreal x1 = info.pos().x();
    qreal y1 = info.pos().y();
    ...
    if (m_action == 8)
    {
        fastMyPaintColor(x1,y1,m_amount);
    }
#endif
...
void MyPaintBrush::paintLine(KisPaintDeviceSP dev,KisPaintDeviceSP layer, const KisPaintInformation &pi1, const KisPaintInformation &pi2)
{
    Q_UNUSED(dev);
    Q_UNUSED(layer);
    Q_UNUSED(pi1);
...
bool MyPaintBrush::point_interpolation( qreal* x, qreal* y, KisImageWSP image ) {
...
void MyPaintBrush::debugColor(const quint8* data){
    QColor rgbcolor;
...
void MyPaintBrush::precomputeDistances(int radius){
...
void MyPaintBrush::bilinear_interpolation(double x, double y, quint8 *dst) {
...
void MyPaintBrush::bilinear_interpolation_old(double x, double y ,quint8 *dst) {
    KoMixColorsOp * mixOp = m_dev->colorSpace()->mixColorsOp();
