 ...
 */
#ifndef KIS_ABR_BRUSH_FACTORY
#define KIS_ABR_BRUSH_FACTORY
 ...
 * of the object.
 */
class BRUSH_EXPORT KisAbrBrushFactory : public KisBrushFactory
{

public:

    /**
     * Creating the KisBrushFactory will load all abr
     * brushes.
     */
    KisAbrBrushFactory();
    virtual ~KisAbrBrushFactory() {}

    virtual QString id() const {
        return "kis_abr_brush";
    }
