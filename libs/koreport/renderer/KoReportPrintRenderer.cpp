...
bool KoReportPrintRenderer::renderPage(int page, const KoReportRendererContext &context, ORODocument *document)
{
    if (document == 0 || context.printer == 0 || context.painter == 0 || page < 0 || page >= document->pages())
        return false;
