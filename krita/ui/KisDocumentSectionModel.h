...
/**
 * Model class for use with KisDocumentSectionView. The document
 * sections that an application uses need to inherit from this class
 * to be displayable in the KisDocumentSectionView. That would be,
 * for instance, pages in Words or KPresenter, layers in Krita or
 * Karbon, sheets in KSpread.
 *
 * The KisDocumentSectionView will display a thumbnail and a row of
 * icon properties for every document section.
 *
 * KisDocumentSectionModel is separate from the flake hierarchy:
