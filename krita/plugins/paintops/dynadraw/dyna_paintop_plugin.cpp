    ...
    : QObject(parent)
{
    ...
    r->add(new KisSimplePaintOpFactory<KisDynaPaintOp, KisDynaPaintOpSettings, KisDynaPaintOpSettingsWidget>("dynabrush", i18n("Dyna"), KisPaintOpFactory::categoryExperimental(), "krita-dyna.png"));
